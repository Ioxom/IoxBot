...
public class ExtraCommands {
    public static void noYoutube(MessageReceivedEvent event) {
        if (event.getAuthor().getId().equals("382659726778957858") && event.getMessage().getContentRaw().contains("https://www.youtu") || event.getMessage().getContentRaw().contains("www.youtube")) {
